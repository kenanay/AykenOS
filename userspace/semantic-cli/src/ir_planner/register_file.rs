...
impl RegisterFile {
    ...
    pub fn set_register(
        ...
        if self.registers.contains_key(&register_id) {
            return Err(RegisterFileError::RegisterAlreadyAssigned {
        ...
        if let Some(existing) = self.registers.get(&register_id) {
            match (existing, &value) {
                ...
                _ => {
                    ...
                    Err(RegisterFileError::RegisterAlreadyAssigned {
                        register: register_id,
                    })
                }
            }
    ...
    pub fn get_register(
        &self,
        register_id: RegisterId,
    ) -> Result<&RegisterValue, RegisterFileError> {
        self.registers
            .get(&register_id)
            .ok_or(RegisterFileError::UndefinedRegister {
                register: register_id,
            })
    }
...
mod tests {
    ...
    fn test_register_file_dump() {
        ...
        register_file
            .set_register(0, RegisterValue::String("test".to_string()))
            .unwrap();
        register_file
            .set_register(1, RegisterValue::Number(42.0))
            .unwrap();
    ...
    fn test_register_statistics() {
        ...
        register_file
            ...
            .unwrap();
        register_file
            .set_register(2, RegisterValue::Boolean(true))
            .unwrap();
