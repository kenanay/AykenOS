        ...
        let operation = match i % 4 {
            0 => Operation::Query {
                ...
                parameters: {
                    ...
                    p.insert(
                        "filter".to_string(),
                        format!("active = true AND id > {}", i.saturating_sub(100)),
                    );
                    p
                },
            },
    ...
    ExecutionPlan {
        ...
        metadata: PlanMetadata {
            ...
            description: Some(format!(
                "Generated plan with {} steps for complexity testing",
                n
            )),
...
fn test_normalization_complexity_budget_1k() {
    ...
    assert!(
        ...
        "Normalization took too long: {:?} for 1K steps",
        duration
    );
...
fn test_normalization_complexity_budget_5k() {
    ...
    println!(
        "✅ Normalization scaling: {}x size took {:.2}x time",
...
fn test_normalization_complexity_budget_max() {
    ...
    assert!(
        ...
        "Normalization took too long: {:?} for MAX_PLAN_STEPS",
        duration
    );
}
...
fn test_ir_analysis_complexity_budget() {
    ...
    println!(
        "✅ IR analysis scaling: {}x size took {:.2}x time",
        size_ratio, time_ratio
    );
}
...
fn test_parallelism_analysis_complexity_budget() {
    ...
    println!(
        "✅ Parallelism analysis scaling: {}x size took {:.2}x time",
        size_ratio, time_ratio
    );
}
...
fn test_complexity_scaling_linearity() {
    ...
    println!(
        "Scaling test: {}x size increase took {:.2}x time (linear would be {:.1}x)",
...
fn test_memory_usage_budget() {
    ...
    let output_ratio =
        canonical_2k.normalized_steps.len() as f64 / canonical_1k.normalized_steps.len() as f64;
    ...
    println!(
        "✅ Memory scaling: {}x input produced {:.2}x output",
...
mod complexity_regression_tests {
    ...
    fn test_small_plan_performance_baseline() {
        ...
        assert!(
            ...
            "Small plan normalization took too long: {:?}",
            duration
        );
    }
    ...
    fn test_empty_plan_performance() {
        ...
        assert!(
            duration < Duration::from_millis(10),
            "Empty plan should be very fast: {:?}",
            duration
        );
