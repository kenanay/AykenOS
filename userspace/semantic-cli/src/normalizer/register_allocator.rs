...
pub enum RegisterAllocationError {
    ...
    RegisterLimitExceeded { category: String, count: u32, limit: u32 },
...
impl RegisterAllocator {
    ...
    pub fn allocate_for_sequence(&mut self, bcib: &BCIBSequence) -> Result<RegisterAllocation, RegisterAllocationError> {
        ...
        Ok(RegisterAllocation {
            ...
            next_register: self.next_data_register.max(self.next_context_register).max(self.next_filter_register),
        })
    }
...
mod tests {
    ...
    fn test_register_limit_enforcement() {
        ...
        match r100.unwrap_err() {
            RegisterAllocationError::RegisterLimitExceeded { category, count, limit } => {
    ...
    fn test_allocation_determinism() {
        ...
        assert_eq!(allocation1.allocated_registers, allocation2.allocated_registers);
    }
}