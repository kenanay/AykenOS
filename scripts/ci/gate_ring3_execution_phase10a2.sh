...
for flag_name in AYKEN_RING3_FETCH_PROBE AYKEN_RING3_SECOND_CANONICAL_PROBE AYKEN_RING3_FRESH_FRAME_PROBE AYKEN_RING3_IRETQ_DIAG_PROBE AYKEN_SHARE_KERNEL_UPPER_HALF AYKEN_RING3_LOW_FETCH_STUB AYKEN_RING3_CANONICAL_FETCH_STUB; do
...
row["evidence_files"] = {
    "build_log": file_meta(sys.argv[17]),
    "boot_audit_log": file_meta(sys.argv[18]),
    "qemu_debugcon_log": file_meta(sys.argv[19]),
    "qemu_serial_log": file_meta(sys.argv[20]),
    "marker_log": file_meta(sys.argv[21]),
    "events_jsonl": file_meta(sys.argv[22]),
}
