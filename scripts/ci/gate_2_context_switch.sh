#!/usr/bin/env bash
# ============================================================================
# Gate-2: Context Switch Validation
# ============================================================================
# Purpose:
#   Validate that context switch mechanism is triggered after boot + timer
#
# Success Criteria:
#   - [[AYKEN_BOOT_OK]] marker appears in debugcon output
#   - [[AYKEN_TICK]] marker appears in debugcon output
#   - [[AYKEN_CTX_SWITCH]] marker appears in debugcon output
...
EVIDENCE_DIR=${EVIDENCE_DIR:-evidence/gate-2-context-switch}
...
echo "=== Gate-2: Context Switch Validation ==="
...
if [[ "$QEMU_EXIT" -ne 0 && "$QEMU_EXIT" -ne 124 ]]; then
    ...
    VERDICT="PASS"
    REASON="Context switch marker observed after boot + timer tick"
fi
...
if [[ "$VERDICT" == "PASS" ]]; then
    ...
    echo "❌ Gate-2 validation failed: $REASON"
    echo ""
...
echo "✅ Gate-2: Context Switch Validation PASS"
