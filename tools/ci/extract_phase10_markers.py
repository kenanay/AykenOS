...
MARKERS = [
    ...
    ("P10_EMBED_HASH_OK", "P10_EMBED_HASH_OK"),
    ("AYKEN_RING3_PREP_OK", "[[AYKEN_RING3_PREP_OK]]"),
    ("P10_TSS_OK", "P10_TSS_OK"),
    ("P10_SCHED_DISPATCH", "P10_SCHED_DISPATCH"),
    ("P10_SCHED_EVENT_NOTIFY", "P10_SCHED_EVENT_NOTIFY"),
    ("P10_IRQ_SCHED_DECISION", "P10_IRQ_SCHED_DECISION"),
    ("P10_MAILBOX_DECISION", "P10_MAILBOX_DECISION"),
    ("P10_DECISION_APPLIED", "P10_DECISION_APPLIED"),
    ("P10_MAILBOX_MISS_FATAL_PRE", "P10_MAILBOX_MISS_FATAL_PRE"),
    ("P10_MAILBOX_MISS_YIELD_FATAL", "P10_MAILBOX_MISS_YIELD_FATAL"),
    ("P10_MAILBOX_MISS_YIELD_NULL", "P10_MAILBOX_MISS_YIELD_NULL"),
    ("P10_MAILBOX_MISS_BLOCK_FATAL", "P10_MAILBOX_MISS_BLOCK_FATAL"),
    ("P10_MAILBOX_MISS_BOOTSTRAP_FATAL", "P10_MAILBOX_MISS_BOOTSTRAP_FATAL"),
    ("P10_MAILBOX_MISS_PRE_USER_BYPASS", "P10_MAILBOX_MISS_PRE_USER_BYPASS"),
    ("P10_MAILBOX_MISS_KEEP_RUNNING", "P10_MAILBOX_MISS_KEEP_RUNNING"),
    ("P10_MAILBOX_MISS_KEEP_RUNNING_INVALID_STATE", "P10_MAILBOX_MISS_KEEP_RUNNING_INVALID_STATE"),
