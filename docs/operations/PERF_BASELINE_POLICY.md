...
**Authority:** Authorized workflow evidence plus Kenan AY maintainer decision
...
6. Record Kenan AY maintainer approval in the PR
7. Merge after CI passes

**Authority:** Kenan AY maintainer approval required
...
4. Record Kenan AY maintainer decision (and the performance rationale)
...
- PR discussion and maintainer decision
...
**This is a constitutional document. Changes require Kenan AY maintainer approval and evidence-based justification.**
