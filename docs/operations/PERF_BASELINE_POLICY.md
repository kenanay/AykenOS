...
**Authority boundary:** A baseline renewal is a reviewed artifact-import
procedure followed by constitutional remote checks. It does not bypass issue
#145, grant merge authority, or establish Phase-17 closure.
...
**Authority:** Reviewed baseline-renewal PR with enforceable independent
reviewer authorization. Until issue #145 is resolved, CI PASS is not merge
authority.
...
5. Request the enforceable independent review required by protected-branch
   governance. Issue #145 blocks treating a review request as live authority
   until the ownership/protection model is repaired.
...
3. Merge only after enforceable required review authority is satisfied
...
Enforceable independent reviewers must verify:
...
The current live-review enforcement gap is tracked by issue #145. Until that
blocker is resolved, this checklist does not authorize a merge.
...
6. Merge only after CI passes and enforceable required review is satisfied
...
**Authority:** Reviewed baseline-renewal PR with enforceable independent
reviewer authorization; runner drift does not waive review governance.
...
**This is a constitutional document. Changes require enforceable independent
review authorization and evidence-based justification.**
