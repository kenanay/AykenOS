...
3. Implement Phase-16 commands in thin orchestration form only: `status`, `gate all`, `closure status --json`, `closure verify`, `head verify`, `bcib verify`, `bcib hash`, `bcib inspect`.
