...
ifneq ($(strip $(USER_MINIMAL_MODE)),)
  VALID_MODES := phase10a2 entry-proof runtime-bridge-test runtime-bridge-ping runtime-bridge-forbidden execution-delivery-proof execution-marker-only phase10a2-text-witness-bp syscall-v2-runtime bcib-forbidden
