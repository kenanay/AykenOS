...
ifneq ($(filter $(AYKEN_RING3_ENTRY_MEM_PROFILE),0 1),$(AYKEN_RING3_ENTRY_MEM_PROFILE))
$(error Invalid AYKEN_RING3_ENTRY_MEM_PROFILE='$(AYKEN_RING3_ENTRY_MEM_PROFILE)'. Use 0 or 1)
endif
...
KERNEL_CFLAGS += -DAYKEN_RING3_ENTRY_MEM_PROFILE=$(AYKEN_RING3_ENTRY_MEM_PROFILE)
...
KERNEL_ASMFLAGS += -DAYKEN_RING3_ENTRY_MEM_PROFILE=$(AYKEN_RING3_ENTRY_MEM_PROFILE)
