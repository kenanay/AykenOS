...
int bcib_worker_create(void) {
...
#if defined(AYKEN_EMBEDDED_ELF_DUAL_PAYLOAD) && (AYKEN_EMBEDDED_ELF_DUAL_PAYLOAD == 1)
    ...
    (void)proc_set_execution_role(worker, PROC_EXECUTION_ROLE_BCIB);
...
int user_worker_create(void) {
    ...
    (void)proc_set_execution_role(worker, PROC_EXECUTION_ROLE_USER);
